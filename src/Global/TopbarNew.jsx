  ...
  >
    <Box className="container">
      ...
      >
        ...
        {/* Logo and title */}
        <Flex justify={{ base: "center", md: "start" }} mr={{ base: -7, md: 0 }}>
          <Flex gap={2} align={"center"} as={Link} to={"/"}>
            <Image
              w={10}
              //src="/Logo.png"               // ✅ Static logo from public folder
              src={`${imageBaseURL}/${logo.value}`}
              fallbackSrc="/logo.svg"       // ✅ Optional fallback
              alt="Siwan Doctor Logo"
            />
            <Text
